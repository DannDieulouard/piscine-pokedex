      ...
      return (
        <section>
            <h2>Random Pokemon : </h2>
                    <>
                    <h3>Nom : {pokemonRandomlyPicked.name}</h3>
                    <h3>Type : {pokemonRandomlyPicked.type}</h3>
                    <h3>Date de capture : {pokemonRandomlyPicked.capturedAt}</h3>
                    <img src={pokemonRandomlyPicked.image} alt={pokemonRandomlyPicked.name} />
                    </>
        </section>
    )
}
